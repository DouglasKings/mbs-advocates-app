...
export default async function Home() {
  ...
  const { data: testimonials, success: testimonialsSuccess } =
      ...
      >
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mb-8 text-lg text-gray-600 sm:text-xl max-w-3xl mx-auto">
            MBS Advocates is a dynamic and client-focused law firm dedicated to
            providing exceptional legal services. Founded on principles of
            integrity, professionalism, and a deep understanding of the law, we
            strive to deliver practical and effective solutions tailored to our
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                MBS Advocates is a premier full-service Ugandan law firm
                established in 2022. Our firm represents an amalgamation of the
                vast experiences and practices of eminent lawyers, creating a
                modern institution with deep roots in legal practice. We embody
                the best qualities of the legal profession: tenacious,
                adaptable, ready for hard work, and committed to our clients'
                causes.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <span className="font-bold">Our Leadership:</span>
                <br />
                Our team is led by experienced legal professionals who bring a
                wealth of knowledge and a meticulous approach to every case.
                Muhangi George (Managing Partner): A highly reputed disputes
                lawyer known for his strategic and effective representation.
                <br />
                Matovu Ronald (Partner): A key partner contributing to the
                firm's diverse expertise and success.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                <span className="font-bold">Our Mission:</span>
                <br />
                To provide high-quality, business-oriented, innovative, and
                cost-effective legal solutions. We are committed to upholding
                the highest standards of legal practice, ensuring our clients
                receive diligent representation and sound advice to achieve
                favorable outcomes.
                <br />
                <br />
                ...
                <br />
                With a network of high-quality, experienced lawyers, we are
                well-placed to service the requirements of our clients across
                Uganda. We are also adequately equipped to handle cross-border
                transactions, working with an established legal network to give
                seamless legal service worldwide.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {testimonialsSuccess && testimonials.length > 0 ? (
            ...
            <p className="text-center text-gray-600 mb-12">
              No testimonials yet. Be the first to share your experience with
              MBS Advocates!
            </p>
          )}
          ...
          <div className="grid grid-cols-1 gap-12">
            ...
            <div className="space-y-8">
              <p className="text-lg text-gray-700">
                We are here to help. Please reach out to us with your legal
                inquiries, and our experienced team will get back to you
                promptly.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-700">
                  ...
                  <span>
                    Plot 26, Wampewo Avenue, Bakwanye House Level 2, West Wing,
                    Opp. Hotel Africana, P.O.Box 111165, Kampala, Uganda
                  </span>
                </div>
                <div className="flex items-center space-x-3 text-gray-700">
